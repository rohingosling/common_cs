...
namespace WhiteBoardCapturer
{
	...
	{	
        ...
        void SetApplicationStateStartUp ()
        {
            ...
            this.activeImageIndex = 0;                                              // 0 = Source Image, > 0 = Processed images
            this.imageCount       = 2;
        ...
        void ProcessImage ()
        {
			...
			{	
                ...
                //imageFilter.Invert       ( bitmapSource, bitmapDestination, this.toolStripProgressBarProcessingImage );   
                imageFilter.GaussianBlur ( bitmapSource, bitmapDestination, 1.3, this.toolStripProgressBarProcessingImage );
                //imageFilter.Emboss       ( bitmapDestination, bitmapDestination, this.toolStripProgressBarProcessingImage );
                //imageFilter.GaussianBlur ( bitmapDestination, bitmapDestination, this.toolStripProgressBarProcessingImage );
        ...
        public void SaveFile ( string fileName, ImageFormat imageFormat )
        {
            try
            {
                ...
                if ( this.activeImageIndex == 0 ) this.pictureBoxSource.Image.Save      ( fileName, imageFormat );      // Save source image.
                if ( this.activeImageIndex == 1 ) this.pictureBoxDestination.Image.Save ( fileName, imageFormat );      // Save destination image.
        ...
        public void SaveFile ( string fileName )
        {
            ...
            ImageFormat imageFormat = this.pictureBoxSource.Image.RawFormat;
		...
		void SaveFileAs ()
        {
            try
            {
                ...
                if ( this.fileOpen )
                {
                    ...
                    saveFileDialog.FileName = this.fileInfo.FullName ;
                    //saveFileDialog.ShowDialog ();
                    SaveFileAsDialog saveFileAsDialog = new SaveFileAsDialog ();
                    ...
                    if ( fileName != string.Empty )
                    {
                        ...
                        if ( saveFileDialog.FilterIndex == 1 ) SaveFile ( fileName, ImageFormat.Jpeg );
                        if ( saveFileDialog.FilterIndex == 2 ) SaveFile ( fileName, ImageFormat.Png);
